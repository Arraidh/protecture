...
const VolunteerCard = ({ showVolunteerForm, setShowVolunteerForm, showVolunteerDetail, setShowVolunteerDetail }) => {
  ...
  return (
    <div className="card gap-3 shadow volunteerCard" onClick={buttonHandlerClickDetail}>
      <img
